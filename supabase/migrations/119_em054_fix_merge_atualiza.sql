-- RAQ-MAND-EM054 — FIX: modo 'mesclar' atualiza o contato com os novos valores
-- Antes (mig 118) o merge era nao-destrutivo (so preenchia vazio) → 2o envio nao atualizava.
-- Agora: valor novo nao-vazio sobrescreve; valor vazio preserva o existente.
-- CREATE OR REPLACE re-cria a funcao com a correcao.
